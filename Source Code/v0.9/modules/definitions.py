...
def action_elements(self):
    ...
    self.gui.server_alias.returnPressed.connect(lambda: server.server_add(self))
    self.gui.server_ip.returnPressed.connect(lambda: server.server_add(self))
    self.gui.server_query.returnPressed.connect(lambda: server.server_add(self))
    self.gui.server_rconport.returnPressed.connect(lambda: server.server_add(self))
    self.gui.server_rconpw.returnPressed.connect(lambda: server.server_add(self))
