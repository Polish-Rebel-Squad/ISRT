...
def map_changer(self):
    ...
    if val_map.startswith("Select") or val_map.startswith("--"):
        ...
        command = ("travel " + val_map_alias_result + "?Scenario=" +
                    val_travel_alias_result + "?Lighting=" + val_light + "?game=" + val_gamemode + comm_mod_mutator)
...
#self.raw_playerid_output = ['ID\t', 'Name\t\t\t\t', 'NetID\t\t\t', 'IP\t\t\t', 'Score\t\t |\n===============================================================================\n256\t', '=TCT= Madman\t', '76561197961263369\t', '37.201.153.6\t', '0\t\t', '0\t', 'Suicide Bomber\t', 'INVALID\t\t', '\t\t', '0\t\t', '0\t', 'Marksman\t\t', 'INVALID\t\t', '\t\t', '0\t\t', '0\t', 'Gunner\t\t', 'INVALID\t\t', '\t\t', '0\t\t', '0\t', 'Breacher\t\t', 'INVALID\t\t', '\t\t', '0\t\t', '0\t', 'Demolitions\t', 'INVALID\t\t', '\t\t', '0\t\t', '0\t', 'Rifleman\t\t', 'INVALID\t\t', '\t\t', '0\t\t', '0\t', 'Breacher\t\t', 'INVALID\t\t', '\t\t', '0\t\t', '0\t', 'Rifleman\t\t', 'INVALID\t\t', '\t\t', '0\t\t', '257\t', 'ISRT Tester\t', '76561199143932113\t', '37.201.153.6\t', '0\t\t', '0\t', 'Rifleman\t\t', 'INVALID\t\t', '\t\t', '0\t\t', '\x00']
